      ...
      <div className='flex flex-row'>
        ...
        >
          <Space className='mx-7 mt-7'>
            ...
            <p className='text-white text-xl' style={{ fontSize: 16 }}>
              {avatarName}
            </p>
          </Space>
          <p
            className='text-white text-xl mx-8 mt-7 mb-4'
            style={{ fontSize: 14 }}
          >
            จัดการบัญชี
          </p>
          ...
          <Button
            className='text-white text-xl mx-12 border-none'
            style={{ fontSize: 14 }}
            icon={<SearchOutlined />}
          >
            เปลี่ยนรหัสผ่าน
          ...
          <Button
            className='text-white text-xl mx-6 mt-20 border-none hover:text-black'
            style={{ fontSize: 14 }}
          >
            <p>ออกจากระบบ</p>
          </Button>
        ...
        >
          <p
            className='text-danger flex justify-center mt-10 text-xl'
            style={{ fontSize: 16 }}
          >
          ...
          <p className='mx-8 mt-4 text-[2]' style={{ fontSize: 16 }}>
            แพคเกจปัจจุบัน
          </p>
          <div
            className='mx-8 mt-4 rounded-md bg-grey'
            style={{ fontSize: 16 }}
          >
            คุณยังไม่มีแพคเกจหรือการการจอง คุณสามารถเริ่ม สมัครแพคเกจ หรือ
            จองก่อนจอง ได้ที่นี่
          </div>
          <p className='mx-8 mt-4 text-[2]' style={{ fontSize: 16 }}>
            สมัครแพคเกจ
          </p>
          ...
          <Pagination
            className='mx-8 mt-32 flex justify-center'
            defaultCurrent={1}
            total={50}
          />
        </div>
